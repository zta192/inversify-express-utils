...
var JsonResult = /** @class */ (function () {
    function JsonResult(json, statusCode, apiController) {
        this.json = json;
        this.statusCode = statusCode;
        this.apiController = apiController;
    }
    JsonResult.prototype.executeAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                response = new httpResponseMessage_1.HttpResponseMessage(this.statusCode);
